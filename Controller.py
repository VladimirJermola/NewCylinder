...
class Controller:
    ...
    def arvuta_click(self):
        radius = self.model.cylinder.get_user_input_radius(self.view.radius_entry.get().strip())
        height = self.model.cylinder.get_user_input_height(self.view.height_entry.get().strip())
